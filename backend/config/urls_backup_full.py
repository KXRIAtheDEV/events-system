"""
URL Configuration for EventHub Project - WORKING VERSION
"""
...
urlpatterns = [
    ...
    path('settings/', login_required(TemplateView.as_view(template_name='attendee/dashboard/settings.html')), name='settings'),
    path('wishlist/', login_required(TemplateView.as_view(template_name='attendee/dashboard/wishlist.html')), name='wishlist'),
    ...
    path('admin-portal/users/detail/', login_required(TemplateView.as_view(template_name='admin/users/detail.html')), name='admin_user_detail'),
    ...
    path('admin-portal/tickets/checkin-history/', login_required(TemplateView.as_view(template_name='admin/tickets/checkin_history.html')), name='admin_checkin_history'),
