// ============================================
// PENDING APPROVALS JS - Admin Event Approval
// Location: static/js/admin/events/pending-approvals.js
// ============================================
...
async function loadPendingEvents() {
    ...
    try {
        ...
        document.getElementById('pendingEventsGrid').innerHTML = 
            '<div class="empty-state"><i class="fas fa-exclamation-circle"></i><p>Failed to load events</p></div>';
    } finally {
        Loader.hide();
    }
}
...
window.refreshPendingEvents = refreshPendingEvents;
